import { Box, Center, Image, Flex,Tabs,TabList,Tab,TabPanel,TabPanels, Badge, Text,Spacer ,Button,ButtonGroup,HStack} from "@chakra-ui/react";
function Navbar(){
    ...
    return (
        ...
        <Box h={{base:"auto",lg:'5rem' ,sm:"auto", md:"3rem"}} w={{base:"100%",lg:"75%", sm:"100%", md:"90%"}} m={'auto'} >
         ...
         <Image w={{base:"1.5rem",lg:'2rem' ,sm:"2rem", md:"2.5rem"}} h={{base:"1.5rem",lg:'2rem' ,sm:"2rem", md:"1.5rem"}} m='auto' src="https://www.kindmeal.my/images/icon_notice.png"></Image>
           <Box m="auto" fontSize={'14px'} color={'grey'} >{"USERNAME"}</Box>
   ...
   <Button colorScheme='white' color={'black'} onClick={()=>{alert("Plz Try To Login With User-ID & Password ")}} w='60px' fontSize={'12px'} >    
Login
  </Button>
...
Sign Up
        ...
        <Tabs variant='unstyled' w={'75%'} m='auto' >
  <TabList color='white' gap='15px' fontSize={'14px'}>
